...
RSpec.describe Types::UnitType do
  ...
  it { is_expected.to have_field(:unit_guide).of_type('String') }
  ...
  it { is_expected.to have_field(:learning_graphs).of_type('[String!]') }
  it { is_expected.to have_field(:rubrics).of_type('[String!]') }
  it { is_expected.to have_field(:summative_assessments).of_type('[String!]') }
  it { is_expected.to have_field(:summative_answers).of_type('[String!]') }
end
